...
public class H3_1 {
    ...
    public void produceArray2Correct() {
        ...
        for (int i = 0; i < array2.length; i++) {
            ...
            assertEquals(ax[i % 3], TutorTests.getAttributeValue(FloorVector.class, "firstAxis", array2[i]), "firstAxis an Index " + i + "nicht korrekt");
            assertEquals(ax[(i + 1) % 3], TutorTests.getAttributeValue(FloorVector.class, "secondAxis", array2[i]), "secondAxis an Index " + i + "nicht korrekt");
        }
    }
