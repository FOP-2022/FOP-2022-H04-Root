...
public class H2_2 {
    ...
    public <C> void valueGetSetSingle(Class<C> c, String attributeName, String setName, String getName, C[] testVals) {
        for (Object testVal : testVals) {
            ...
            //getter
            assertEquals(testVal, TutorTests.callMethod(FloorVector.class, getName, new Class[]{}, fvector, new Object[]{}), getName + " aus " + c.getName() + " liefert nicht den gesetzten Wert");
            //und value
            assertEquals(testVal, TutorTests.getAttributeValue(FloorVector.class, attributeName, fvector), attributeName + " aus " + c.getName() + " wird nicht auf den Wert gesetzt");
        }
    }
